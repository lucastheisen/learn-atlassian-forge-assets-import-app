...
const OPENAPI_JSON = `https://dac-static.atlassian.com/cloud/assets/swagger.${API_VERSION}.json?_v=${VERSION}`
...
async function main(): Promise<void> {
  const finalDoc = await readPatchedSchema<OpenAPI3>(schemaFile, OPENAPI_JSON)
